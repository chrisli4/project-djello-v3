	...
	switch(action.type) {
		...
		case LIST_CREATE: 
			return {
				...
				successful: false,
				messages: [{
					body: `${action.list.id} being created...`,
					time: Date.now()
				}],
				errors: []
			}
		...
		case LIST_UPDATE_SUBMIT:
			return {
				...
				successful: false,
				messages: [{
					body: `${action.list.id} being updated...`,
					time: Date.now()
				}],
				errors: [],
			}
		...
		case LIST_DELETE: 
			return {
				...
				successful: false,
				messages: [{
					body: `${action.list.id} being deleted...`,
					time: Date.now()
				}],
				errors: [],
			}
